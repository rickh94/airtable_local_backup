...
release = airtable_local_backup.__version__
...
htmlhelp_basename = 'AirtableLocalBackupdoc'
...
latex_documents = [
    (master_doc, 'AirtableLocalBackup.tex', 'Airtable Local Backup Documentation',
     'Rick Henry', 'manual'),
]
...
man_pages = [
    (master_doc, 'airtablelocalbackup', 'Airtable Local Backup Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AirtableLocalBackup', 'Airtable Local Backup Documentation',
     author, 'AirtableLocalBackup', 'One line description of project.',
     'Miscellaneous'),
]
